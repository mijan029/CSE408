    ...
    return (
        <div className="grid grid-cols-3">
            ...
            <div className="flex flex-col  ml-10 mr-20 col-span-2">
                    <SearchBar setKeyWord={setKeyWord} />
                        ...
                        history.map( item=>(
                                    ...
                                    (item.purchaseList.filter(e=> (e.name.match(keyWord)) )).length ?  (<div className=" rounded-lg my-5 p-5 bg-white">
                                        <p className="text-gray-500">Id: {item._id}</p>
                                        <p className="text-gray-500">Date & Time: {new Date(item.purchaseDate).toLocaleString('en-US',{
                                                            day: 'numeric',
                                                            month: 'short',
                                                            year: 'numeric',
                                                            hour: 'numeric',
                                            ...
                                            <div className="overflow-x-auto mt-14 bg-white rounded">
                                                ...
                                                <div className='m-5 float-right'>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={ async ()=>{await axios.delete(`/factory/raw/purchaseHistory/${item._id}`)
                                                                                fetchHistory()
                                                                            } }
                                                    >
                                                    Delete </button>
            ...
            <div className="col-span-1 flex flex-col">
                <SearchByDate setHistory={setHistory} api='/factory/raw/purchaseHistory' />
                <DeleteByDate fetchHistory={fetchHistory} api='/factory/raw/purchaseHistory' />
            </div>
